        ...
        <main id="main" class="site-main" role="main">
            ...
            <header class="page-header layout-center-content text-center">
                ...
                <div class="header-content container-fluid">
                    <?php if ( have_posts() ) : ?>
                        <h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'dixeed-2023' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
                    <?php else : ?>
                        <h1 class="page-title"><?php _e( 'Nothing Found', 'dixeed-2023' ); ?></h1>
                    <?php endif; ?>
