 ...
 */
function dixeed_2023_customize_register( $wp_customize )
{
    ...
    $wp_customize->selective_refresh->add_partial( 'blogname', array(
        ...
        'render_callback' => 'dixeed_2023_customize_partial_blogname',
    ) );

    $wp_customize->selective_refresh->add_partial( 'blogdescription', array(
        'selector' => '.site-description',
        'render_callback' => 'dixeed_2023_customize_partial_blogdescription',
    ) );
...
//        'title' => __( 'Theme Options', 'dixeed-2023' ),
//        'priority' => 130, // Before Additional CSS.
//    ) );
//
//    $wp_customize->add_section( 'post_types', array(
//        'title' => __( 'Post Type Archives', 'dixeed-2023' ),
//        'priority' => 130, // Before Additional CSS.
//    ) );
...
//            'type' => 'radio',
//            'description' => __('You can make your own layout in header.php and ignore all this.', 'dixeed-2023'),
//            'choices' => array(
//                'yes' => 'yes',
//                'no' => 'no'
//            )
...
//        array(
//            'label' => __( 'Contain the site top items', 'dixeed-2023' ),
//            'section' => 'theme_options',
//            'type' => 'select',
//            'choices' => array(
//                'container' => 'contained',
...
//            ),
//            'description' => __('You can set contained size via $container in scss', 'dixeed-2023')
//        ) );
...
//            'section' => 'theme_options',
//            'type' => 'select',
//            'description' => __('You can make your own layout in php in header.php and ignore presets and manual settings.', 'dixeed-2023'),
//            'choices' => array(
//                'logo-left' => 'logo-left',
...
add_action( 'customize_register', 'dixeed_2023_customize_register' );
 ...
 *
 * @since Ignition 1.0
 * @see dixeed_2023_customize_register()
 *
 * @return void
 */
function dixeed_2023_customize_partial_blogname()
{
    bloginfo( 'name' );
}
 ...
 * @return void
 */
function dixeed_2023_customize_partial_blogdescription()
{
 ...
 */
function dixeed_2023_customize_preview_js()
{
    wp_enqueue_script( 'dixeed-2023-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js'
    ), array('jquery', 'customize-preview'), '1.0', true );
}

add_action( 'customize_preview_init', 'dixeed_2023_customize_preview_js' );

/**
 * Load dynamic logic for the customizer controls area.
 */
function dixeed_2023_panels_js()
{
    wp_enqueue_script( 'dixeed-2023-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
//add_action( 'customize_controls_enqueue_scripts', 'dixeed_2023_panels_js' );
